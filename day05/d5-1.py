...
# to be immediately before 53; other pages are allowed to 
# be between them.)

# The second section specifies the page numbers of each update. Because 
# most safety manuals are different, the pages needed in the updates 
# are different too. The first update, 75,47,61,53,29, means that the 
...
#     		every other page must be after it according to 47|61, 
#     		47|53, and 47|29.
#     61 is correctly in the middle because 75 and 47 are before it 
#     		(75|61 and 47|61) and 53 and 29 are after it 
#     		(61|53 and 61|29).
...
# of each correctly-ordered update. In the above example, the correctly-ordered 
# updates are:
