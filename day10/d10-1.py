...
# You all arrive at a Lava Production Facility on a floating 
# island in the sky. As the others begin to search the massive 
# industrial complex, you feel a small nose boop your leg and 
# look down to discover a reindeer wearing a hard hat.

# The reindeer is holding a book titled "Lava Island Hiking Guide". 
# However, when you open the book, you discover that most of it 
# seems to have been scorched by lava! As you're about to ask how 
# you can help, the reindeer brings you a blank topographic map 
...
def main():
    ...
    for t_head in trailheads:
        final_coords = move(top_map, t_head)
        print(f'head {t_head}: {final_coords}')
