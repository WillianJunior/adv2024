    ...
    for antn, coords in all_antennas_coords.items():
        ...
        while len(coords) > 1:
            ...
            for i, j in coords:
                ...
                test1_i = base_i + dist_i
                test1_j = base_j + dist_j
                if (0 <= test1_i < h) and (0 <= test1_j < w):
                ...
                test2_i = i - dist_i
                test2_j = j - dist_j
                if (0 <= test2_i < h) and (0 <= test2_j < w):
                    # print(f'antinode2 {base_i,base_i}/{i,j} '
                    #       f'in {test2_i,test2_j}')
                    antinode_map[test2_i, test2_j] = 1
